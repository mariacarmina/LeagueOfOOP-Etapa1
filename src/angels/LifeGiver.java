...
public class LifeGiver extends Angel {
     ...
     * ingerului.
     * LifeGiver ofera un boost pentru HP pana ajunge la maxim, deci adminul
     * va fi notificat cand acest inger va ajuta un erou, prin
    ...
    public void visit(final Knight knight) {
        int increaseHP = heal(Constants.KNIGHT_LIFEGIVER_HP, knight);
    ...
    public void visit(final Pyromancer pyromancer) {
        int increaseHP = heal(Constants.PYROMANCER_LIFEGIVER_HP, pyromancer);
    ...
    public void visit(final Rogue rogue) {
        int increaseHP = heal(Constants.ROGUE_LIFEGIVER_HP, rogue);
    ...
    public void visit(final Wizard wizard) {
        int increaseHP = heal(Constants.WIZARD_LIFEGIVER_HP, wizard);
